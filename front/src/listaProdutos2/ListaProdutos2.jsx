...
export const ContainerFiltros2 = () => (
...
const ContainerProduto2 = () => {
    ...
    <div >
        {
            produtos.map(p => (<CardProduto2 id={p.id} nome={p.nome} preco={p.valor} foto={no_img} vendedor={p.fornecedor_nome} />) )
        }
    </div>
)};

export const CardProduto2 = ({ id, preco, nome, foto, vendedor }) => (
    
        <div className="containerProduto">
            <div className="cardFoto">
                { /*<img src={`data:image/jpeg;base64,${qr_code_base64}`} height='150px' width='150px'/> */}
                <img src={foto} height='150px' width='150px'/>
            </div>
            <div className="containerInfos">
                <div className="cardNome">
                    <Link to={`/produto/${id}`} className="Link">{nome}</Link>
